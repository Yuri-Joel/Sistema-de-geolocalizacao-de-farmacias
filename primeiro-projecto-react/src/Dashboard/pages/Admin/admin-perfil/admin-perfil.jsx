...
export default function Adminperfil() {
  ...
  const HandleSubmit = async (e) => {
    ...
    if ((Alterar.novaSenha === ConfimarSenha) && Alterar.senhaActual.trim() && ConfimarSenha.trim() && Alterar.novaSenha.trim()) {
      await axios.put(`http://localhost:8800/ad/updadminsenha/${Idusuario}`, Alterar)
        .then(res => {
  ...
  const ActualizarUser = async (e) => {
    ...
    try {
      const res = await axios.put(`http://localhost:8800/ad/updadmin/${Idusuario}`, User)
      console.log(res.data.data)
                ...
                <div className="col-xl-4">
                  ...
                  <div className="card">
                    <div className="card-body profile-card pt-4 d-flex flex-column align-items-center">
                      {userPhoto ?
                        <img src={`http://localhost:8800/${userPhoto}`} alt="Profile" style={{ borderRadius: '100%', width: '12rem', height: '8rem' }} className="rounded-circle" />
                        :
                              ...
                              <form onSubmit={ActualizarUser}>
                                <div className="row mb-3">
                                  ...
                                  <div className="col-md-8 col-lg-9">
                                    {userPhoto ?
                                      <img src={`http://localhost:8800/${userPhoto}`} alt="Profile" style={{ borderRadius: '100%', width: '12rem', height:'8rem'}}  className="" />
                                      :
                                      <img src={imagem} alt='profile' className='rounded-circle' />
                                    }
                                    <div className="pt-2">
                                      <input type="file" className="btn btn-primary btn-sm" title="Upload new profile imag" onChange={(e) => setNewImage(e.target.files[0])} />
                                      <br></br> <br></br>
