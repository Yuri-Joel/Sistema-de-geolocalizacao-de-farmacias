...
export default function HeaderAdmin({on}) {
...
<a href="index.html" className="logo d-flex align-items-center">
 <img src='../../../../assets/Geo Farma/Geo Farma.png' alt="eee" />
 <span className="d-none d-lg-block"style={{color:'white'}}>GeoFarma</span>
</a>
<i className="bi bi-list toggle-sidebar-btn  collapsed"onClick={on} style={{color:'white'}} data-bs-toggle="collapse"  data-bs-target="#sidebar"></i>
...
<ul className="d-flex align-items-center">
 ...
 <li className="nav-item dropdown pe-3">
   <a className="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
     ...
     <span className="d-none d-md-block dropdown-toggle ps-2"><NomeAdmin /></span>
   </a>
